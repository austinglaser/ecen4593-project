/**
 * @file    test_CacheData_FullyAssociative.c
 * @author  Austin Glaser <austin@boulderes.com>
 * @brief   TestCacheDataFullyAssociative Source
 *
 * @addtogroup TEST_CACHEDATA_FULLYASSOCIATIVE
 * @{
 */
...
static const uint32_t set_len          = 8;
